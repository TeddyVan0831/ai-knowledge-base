...
- **Harness Engineering 视角（2026-07 新增）**: [Harness Engineering（harness 工程）](/agent/concept-harness-engineering)（T4 独立控制是四问法关键）、[Harness 四问法（边界判断工具）](/agent/concept-harness-four-questions)、[Agent 任务生命周期](/agent/concept-agent-task-lifecycle)
