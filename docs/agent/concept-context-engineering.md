...
- **Harness Engineering 视角（2026-07 新增）**: [Harness Engineering（harness 工程）](/agent/concept-harness-engineering)（Context Engineering 是 L1 指导与上下文层，不能独立保障 Agent 任务）、[Harness 四问法（边界判断工具）](/agent/concept-harness-four-questions)（T3 任务感知上下文是四问法关键）
- 参见: [Agent 开发全览 — 从原理到实践](/agent/topic-agent-development), [Agent Harness 工程综述（2026）](/agent/topic-harness-engineering-2026)
